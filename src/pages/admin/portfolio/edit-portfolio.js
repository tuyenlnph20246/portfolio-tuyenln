...
const PortfolioAdminEditPage = ({id}) => {
  ...
  useEffect(()=>{
   ...
   formPort.addEventListener("submit", async (e)=>{
    try {
      e.preventDefault();
      const urlPortEdit = await uploadFiles(proImages.files);
      const formData = {
        id,
        name: proName.value,
        images: urlPortEdit,
  ...
  return (
    ...
    <div class="flex flex-col gap-3">
      ...
      <input type="text" id="project-name" class="border py-2 px-1 rounded-md focus:outline-none focus:border-sky-500 focus:ring-sky-500 focus:ring-1" value=${portfolio.name}>
    </div>
    <div class="flex flex-col gap-3">
    ...
    <div class="flex flex-col gap-3 mt-3">
      ...
      <input type="text" id="project-desc" class="border py-2 px-1 rounded-md focus:outline-none focus:border-sky-500 focus:ring-sky-500 focus:ring-1" value=${portfolio.desc}>
    </div>
    <div class="flex flex-col gap-3 mt-3">
      <label for="" class="text-xl">Thời gian làm</label>
      <input type="text" id="project-time" class="border py-2 px-1 rounded-md focus:outline-none focus:border-sky-500 focus:ring-sky-500 focus:ring-1" value=${portfolio.time}>
    </div>
    <div class="flex flex-col gap-3 mt-3">
      <label for="" class="text-xl">Link git hub</label>
      <input type="text" id="project-github" class="border py-2 px-1 rounded-md focus:outline-none focus:border-sky-500 focus:ring-sky-500 focus:ring-1" value=${portfolio.github}>
    </div>
    <div class="flex flex-col gap-3 mt-3">
      <label for="" class="text-xl">Đánh giá</label>
      <input type="text" id="project-feedback" class="border py-2 px-1 rounded-md focus:outline-none focus:border-sky-500 focus:ring-sky-500 focus:ring-1" value=${portfolio.feedback}>
    </div>
    <div class="flex flex-col gap-3 mt-3">
      <label for="" class="text-xl">Ngôn ngữ làm việc</label>
      <input type="text" id="project-language" class="border py-2 px-1 rounded-md focus:outline-none focus:border-sky-500 focus:ring-sky-500 focus:ring-1" value=${portfolio.language}>
    </div>
...
export default PortfolioAdminEditPage